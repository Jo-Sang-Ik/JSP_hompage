 ...
 * Generated at: 2020-05-07 02:34:06 UTC
...
public final class order_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_packages.add("com.plantshop.item");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>주문 목록 보기</title>\r\n");
      ...
      out.write("<link href=\"./css/order_list.css\" rel=\"stylesheet\">\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
...
if(session.getAttribute("login_id") == null) { // 로그인이 되지 않은 상태
 ...
 if(login_id.equals("admin") == true) { login_name = "관리자"; 
      ...
      out.write("   \t\t<a href=\"../cart/cart_list.jsp\">나의 장바구니</a>\r\n");
      out.write("   \t\t<a id=\"current_page\" href=\"./order_list.jsp?uid=");
      out.print(login_id );
	...
	if(saleOrderList.isEmpty()) {
      ...
      out.write("\r\n");
      out.write("\t\t\t<div class=\"order\"><a class=\"move\" href=\"order_list.jsp?buyId=");
      out.print(buyId );
      out.write("&uid=");
      out.print(uid );
      out.write("\">현재 주문서만 보기</a></div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<table id=\"info_table\">\r\n");
      out.write("\t\t\t<tr><th width=\"20%\">주문 번호</th><td width=\"80%\">");
      out.print( buyId  );
      out.write("</td></tr>\r\n");
      out.write("\t\t\t<tr><th>주문 날짜</th><td>");
      out.print( saleOrder.getOrderdate()  );
      out.write("</td></tr>\r\n");
      out.write("\t\t\t<tr><th>고객 이름</th><td>");
      out.print( saleOrder.getName()  );
      out.write("</td></tr>\r\n");
      out.write("\t\t\t<tr><th>결제 유형</th><td>");
      out.print( saleOrder.getPay() );
      out.write(' ');
      out.write(':');
      out.write(' ');
      out.print( saleOrder.getCardno()  );
      out.write("</td></tr>\r\n");
      out.write("\t\t\t<tr><th>배달 주소</th><td>");
      out.print( saleOrder.getAddress() );
      out.write("</td></tr>\r\n");
      out.write("\t\t\t<tr><th>전화 번호</th><td>");
      out.print( saleOrder.getTel() );
      out.write("</td></tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t");
 ...
 for(ItemDataBean item : itemList) {
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td width=\"7%\" class=\"center\">");
      out.print( item.getItemno());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td width=\"7%\" class=\"center border_right\">\r\n");
      out.write("\t\t\t\t\t\t<a href=\"../product/product_detail.jsp?id=");
      out.print(item.getProductid() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t<img src=\"/plantshop/");
      out.print(product.getSmall_img() );
      out.write("\" width=\"80px\" height=\"110px\"></a>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td width=\"31%\" class=\"center border_left\">\r\n");
      out.write("\t\t\t\t\t\t<a href=\"../product/product_detail.jsp?id=");
      out.print(item.getProductid() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("</a>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td width=\"15%\" class=\"center\">");
      out.print(item.getProductid() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td width=\"7%\" class=\"center\">");
      out.print(qty );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td width=\"20%\" class=\"center\">");
      out.print(nf.format(price) );
      out.write(" 원</td>\r\n");
      out.write("\t\t\t\t\t<td width=\"20%\" class=\"center\">");
      out.print(nf.format(qty*price) );
      out.write(" 원</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t");
 } 
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t<div class=\"total\">주문상품 : ");
