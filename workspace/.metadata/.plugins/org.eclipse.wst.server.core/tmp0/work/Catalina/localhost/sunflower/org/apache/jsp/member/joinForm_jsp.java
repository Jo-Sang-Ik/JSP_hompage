 ...
 * Generated at: 2020-05-08 01:31:58 UTC
...
public final class joinForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<link href=\"./css/joinForm.css\" rel=\"stylesheet\">\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
...
if(session.getAttribute("login_id") == null) { // 로그인이 되지 않은 상태
 ...
 if(login_id.equals("admin") == true) { login_name = "관리자"; 
      ...
      out.write("\t\t\t<form action=\"joinProc.jsp\" method=\"post\" name=\"join\" onsubmit=\"return doSubmit()\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th width=\"15%\">아이디<mark>*</mark></th>\r\n");
      out.write("\t\t\t\t\t\t<td width=\"85%\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"userid\" maxlength=\"16\" size=\"20\" autofocus>&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"button\" class=\"btns\" value=\"중복확인\" onclick=\"MM_openBrWindow('useridCheck.jsp', 'userid_check', 'width=500px, height=450px')\">&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t<small>(영문+숫자 5~16자리)<font color=\"red\"> 중복 확인 절차를 거쳐야 합니다.</font></small>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>비밀번호<mark>*</mark></th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"password\" name=\"password\" maxlength=\"12\" size=\"20\" onkeyup=\"pwdCheck();\"><small>&nbsp;(영문+숫자 4~12자리)</small> \r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>비밀번호 확인<mark>*</mark></th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"password\" name=\"password2\" maxlength=\"12\" size=\"20\" onkeyup=\"pwdCheck();\"><span id=\"pwdCheckCircle\"></span>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>이름<mark>*</mark></th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"username\" maxlength=\"10\" size=\"20\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>EMAIL<mark>*</mark></th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"email\" name=\"email\" maxlength=\"50\" size=\"20\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr class=\"address\">\r\n");
      out.write("\t\t\t\t\t\t<th>우편번호<mark>*</mark></th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"zipcode1\" maxlength=\"3\" size=\"3\"> -\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"zipcode2\" maxlength=\"3\" size=\"3\">&nbsp;\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<small><font color=\"red\">우편번호 검색 버튼을 누르세요.</font></small>\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr class=\"address\">\r\n");
      out.write("\t\t\t\t\t\t<th>주소<mark>*</mark></th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"address1\" maxlength=\"100\" size=\"50\">&nbsp;\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>나머지 주소<mark>*</mark></th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"address2\" maxlength=\"100\" size=\"50\">\r\n");
      out.write("\t\t\t\t\t\t\t<small><font color=\"red\">나머지 주소를 입력하세요.</font></small>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th class=\"phone_row\">전화번호<mark>*</mark></th>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"phone_row\">\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"phone1\" style=\"width:82px; height:32px; font-size: 15px; border: 1px solid black;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</select> - \r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"phone2\" maxlength=\"4\" size=\"4\"> - \r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"phone3\" maxlength=\"4\" size=\"4\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr class=\"end_row\">\r\n");
      out.write("\t\t\t\t\t\t<th colspan=\"2\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"userid_check\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"submit\" class=\"btns\" value=\"확인\">&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"reset\" class=\"btns\" value=\"다시쓰기\" >&nbsp;\r\n");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<script src=\"./js/joinForm.js\"></script> \r\n");
      out.write("\t\t<!--  body의 document.body.offsetWidth 값과 height 값을 가져오기 위해 body아래에서 script문 실행 -->\r\n");
      out.write("\t</section>\r\n");
      out.write("\t");
      out.write("\r\n");
      out.write("<!DOCTYPE html>\r\n");
