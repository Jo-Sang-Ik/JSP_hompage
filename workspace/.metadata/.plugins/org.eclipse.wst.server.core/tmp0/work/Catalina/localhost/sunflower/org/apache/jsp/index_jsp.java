 ...
 * Generated at: 2020-05-08 03:22:05 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<!-- 상품 슬라이더 -->\r\n");
      out.write("<script src=\"plugins/carousel/jquery-touchslider.js\"></script>\r\n");
...
if(session.getAttribute("login_id") == null) { // 로그인이 되지 않은 상태
 ...
 if(login_id.equals("admin") == true) { login_name = "관리자"; 
      ...
      out.write("\t\t\t\t<div id=\"banner_frame\">\r\n");
      out.write("\t\t\t\t\t<div id=\"banner_main\">\r\n");
      out.write("\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"banner_item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"shop_list.jsp?category=11\"><img src=\"image/banner1.jpg\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"banner_item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"shop_list.jsp?category=331\"><img src=\"image/banner2.jpg\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"banner_item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"shop_list.jsp?category=22\"><img src=\"image/banner3.jpg\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\t\r\n");
      out.write("\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"banner_item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"shop_list_item.jsp?item=sale\"><img src=\"image/banner4.jpg\"></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"banner_controls\">\r\n");
      out.write("\t\t\t\t\t\t<img src=\"image/banner_left.png\" width=\"80px\" height=\"80px\" class=\"banner_prev\"></img>\r\n");
      out.write("\t\t\t\t\t\t<img src=\"image/banner_right.png\" width=\"80px\" height=\"80px\" class=\"banner_next\"></img>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"banner_paging\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"slider-count\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</article>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<article id=\"article2\">\r\n");
      out.write("\t\t\t<div id=\"title1\"><a href=\"shop_list_item.jsp?item=best\">베스트 셀러</a></div>\r\n");
      out.write("\t\t\t<div id=\"popular_product\">\r\n");
      out.write("\t\t\t\t<div id=\"popular_product_frame\">\r\n");
      out.write("\t\t\t\t\t<div id=\"popular_product_touchslider\">\r\n");
      out.write("\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"popular_product_item\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
 for(int j=item_count; j<item_count+4; j++) {
										ProductDataBean product = productList.get(j); 
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"product/product_detail.jsp?id=");
      out.print(product.getId() );
      out.write("\"><img src=\"");
      out.print(url+"/"+product.getSmall_img());
      out.write("\">\r\n");
      out.write("\t\t\t\t        \t\t\t\t\t<span>");
	...
	item_count+=4;
      ...
      out.write("\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"popular_product_controls\">\r\n");
      out.write("\t\t\t\t\t\t<img src=\"image/left-arrow.png\" width=\"80px\" height=\"80px\" class=\"popular_product_prev\"></img>\r\n");
      out.write("\t\t\t\t\t\t<img src=\"image/right-arrow.png\" width=\"80px\" height=\"80px\" class=\"popular_product_next\"></img>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"popular_product_paging\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"slider-count\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</article>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<article id=\"article3\">\r\n");
      out.write("\t\t\t<div id=\"title2\"><a href=\"shop_list_item.jsp?item=new\">새로운 상품</a></div>\r\n");
      out.write("\t\t\t<div id=\"new_product\">\r\n");
      out.write("\t\t\t\t<div id=\"new_product_frame\">\r\n");
      out.write("\t\t\t\t\t<div id=\"new_product_touchslider\">\r\n");
      out.write("\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"new_product_item\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
 for(int j=item_count2; j<item_count2+4; j++) {
	...
	item_count2+=4;
      ...
      out.write("\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"new_product_controls\">\r\n");
      out.write("\t\t\t\t\t\t<img src=\"image/left-arrow2.png\" width=\"80px\" height=\"80px\" class=\"new_product_prev\"></img>\r\n");
      out.write("\t\t\t\t\t\t<img src=\"image/right-arrow2.png\" width=\"80px\" height=\"80px\" class=\"new_product_next\"></img>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"new_product_paging\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"slider-count\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</article>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<article id=\"article4\">\r\n");
      out.write("\t\t\t<div id=\"title3\"><a href=\"shop_list.jsp?category=44\">꽃과 함께하면 좋은 상품</a></div>\r\n");
      out.write("\t\t\t<div id=\"prop_product\">\r\n");
      out.write("\t\t\t\t<div id=\"prop_product_frame\">\r\n");
      out.write("\t\t\t\t\t<div id=\"prop_product_touchslider\">\r\n");
      out.write("\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"prop_product_item\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
 for(int j=item_count3; j<item_count3+4; j++) {
	...
	item_count3+=4;
      ...
      out.write("\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"prop_product_controls\">\r\n");
      out.write("\t\t\t\t\t\t<img src=\"image/left-arrow3.png\" width=\"80px\" height=\"80px\" class=\"prop_product_prev\"></img>\r\n");
      out.write("\t\t\t\t\t\t<img src=\"image/right-arrow3.png\" width=\"80px\" height=\"80px\" class=\"prop_product_next\"></img>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"prop_product_paging\"></div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"slider-count\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
