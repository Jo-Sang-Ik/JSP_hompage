...
<link href="./css/modifySession.css" rel="stylesheet">
...
<jsp:setProperty property="userid" name="article" value="<%=userid %>" />
...
%>
	<div id="modifyform">
		<form name="join" action="modifySession.jsp" method="post">
		...
		<table>
			<tr>
				<th width="15%">아이디</th>
				<td width="85%">
					<input type="text" name="userid" maxlength="16" size="20" value="<%=userid %>" readonly>&nbsp;<font color="red"><small>* 아이디는 변경할 수 없습니다.</small></font>
				</td>
			</tr>
			...
			<tr>
				<th>비밀번호 확인</th>
				<td>
					<input type="text" name="password2" maxlength="12" size="20" value="<%=user.getPassword() %>" onkeyup="pwdCheck()" onclick="pwdCheck()"><span id="pwdCheckCircle">
				</td>
			</tr>
			<tr>
				<th>이름</th>
			...
			<tr>
				...
				<td>
					...
					<small><font color="red">나머지 주소를 입력해주세요.</font></small>
				</td>
			</tr>
			<tr>
				<th>전화번호</th>
			...
			<tr class="end_row">
				<th colspan="2">
					...
					<input type="button" class="btns" value="메인페이지" onclick="location.href='../index.jsp'">
				</th>
			</tr>
		</table>
		</form>
